...
import com.jinshu.homelibrary.recyclerview.animation.AlphaInAnimation;
import com.jinshu.homelibrary.recyclerview.animation.BaseAnimation;
import com.jinshu.homelibrary.recyclerview.bean.SPageBean;
 ...
 */
public abstract class FCommonRecycleViewAdapter<T> extends RecyclerView.Adapter<SViewHolderHelper> implements FDataIO<T> {
    ...
    public FCommonRecycleViewAdapter(Context context, int layoutId) {
        mContext = context;
    ...
    public FCommonRecycleViewAdapter(Context context, int layoutId, List<T> mDatass) {
        mContext = context;
        mInflater = LayoutInflater.from(context);
        mLayoutId = layoutId;
        mDatas = mDatass;
